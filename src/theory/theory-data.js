...
<p>Una grandezza <strong>vettoriale</strong> richiede anche una direzione e un verso per essere descritta completamente (es. forza, velocità, spostamento).</p>
...
<p><strong>Modulo</strong> (o intensità): la lunghezza del vettore, sempre un numero positivo.</p>
...
<p>Se conosciamo le componenti cartesiane Vx e Vy, possiamo calcolare modulo e angolo.</p>`,
  ...
  'vector-sum': {
    ...
    category: 'vettori',
    content: `<p>La somma di due o più vettori si chiama <strong>risultante</strong>.</p>
...
<p>In componenti, la somma è semplicemente la somma delle singole componenti.</p>`,
    formula: 'R = A + B\nRx = Ax + Bx\nRy = Ay + By',
    example: 'A = (3, 2), B = (1, 4)\nR = (3+1, 2+4) = (4, 6)\n|R| = \u221a(16 + 36) = \u221a52 \u2248 7.21',
  },
...
<p>Il modulo del vettore risultante è |k| volte il modulo dell'originale.</p>`,
  ...
  'force-basics': {
    ...
    category: 'forze',
    content: `<p>Una <strong>forza</strong> è una grandezza vettoriale che descrive l'interazione tra due corpi.</p>
...
<p>Secondo la seconda legge di Newton, la forza è uguale alla massa per l'accelerazione.</p>`,
    formula: 'F = m \u00b7 a',
  ...
  'force-weight': {
    title: 'Forza Peso',
    category: 'forze',
    content: `<p>La <strong>forza peso</strong> (o forza di gravità) è la forza con cui la Terra attrae un corpo verso il suo centro.</p>
<p>È diretta sempre verso il basso (verso il centro della Terra) ed è proporzionale alla massa del corpo.</p>
<p>Il valore di g sulla superficie terrestre è circa 9.81 m/s\u00b2.</p>`,
  ...
  'force-normal': {
    title: 'Forza Normale',
    category: 'forze',
    content: `<p>La <strong>forza normale</strong> è la forza di reazione esercitata da una superficie su un corpo appoggiato su di essa.</p>
...
<p>Su un piano inclinato di angolo \u03b1, la forza normale è la componente perpendicolare del peso.</p>`,
...
<p>La forza è proporzionale all'allungamento (o compressione) della molla rispetto alla sua posizione di equilibrio.</p>
...
<p><strong>Py</strong> (componente perpendicolare al piano): viene equilibrata dalla forza normale.</p>`,
  ...
  'force-tension': {
    ...
    category: 'forze',
    content: `<p>La <strong>tensione</strong> è la forza trasmessa attraverso una corda, filo o cavo quando viene tirato.</p>
...
<p>Se le masse sono diverse, il sistema accelera nella direzione della massa maggiore.</p>`,
  ...
  'equilibrium': {
    title: 'Equilibrio',
    category: 'forze',
    content: `<p>Un corpo è in <strong>equilibrio</strong> quando la somma vettoriale di tutte le forze applicate è zero.</p>
...
<p>Per verificare l'equilibrio, si controlla che la somma delle componenti x e la somma delle componenti y siano entrambe zero.</p>`,
  ...
  'point-forces': {
    ...
    category: 'forze',
    content: `<p>Quando più forze agiscono su uno stesso punto, si possono sommare vettorialmente per trovare la <strong>risultante</strong>.</p>
<p>Il metodo più pratico è scomporre ogni forza nelle componenti x e y, sommare separatamente le componenti, e poi ricomporre il vettore risultante.</p>
<p>La risultante ha lo stesso effetto di tutte le forze agenti insieme.</p>`,
  ...
  'equilibrio-punto': {
    ...
    category: 'equilibrio',
    content: `<p>Un punto materiale è in <strong>equilibrio</strong> quando la somma vettoriale di tutte le forze applicate è nulla.</p>
...
<p>Una <strong>coppia di forze</strong> è formata da due forze uguali e contrarie applicate in punti diversi; produce solo rotazione.</p>`,
  ...
  'corpo-rigido': {
    ...
    category: 'equilibrio',
    content: `<p>Un corpo rigido è in equilibrio quando: <strong>\u03a3F = 0</strong> (equilibrio alla traslazione) e <strong>\u03a3M = 0</strong> (equilibrio alla rotazione).</p>
