...
export function createInclinedPlaneSolver() {
  return createSolver({
    variables: [
      ...
      { id: 'mu', label: 'Coeff. attrito (\u03BC)', unit: '', defaultValue: 0.58, mode: 'input' },
...
export function getInclinedPlaneConfig() {
  return { id: 'inclined-plane', label: 'Piano inclinato', defaults: { mass: 4, angleDeg: 30, frictionCoeff: 0.58 } };
}
